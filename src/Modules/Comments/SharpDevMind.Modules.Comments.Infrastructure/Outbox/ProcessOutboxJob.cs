...
namespace SharpDevMind.Modules.Comments.Infrastructure.Outbox;
...
{
    private const string ModuleName = "Posts";
        ...
        Exception? exception)
    {
        const string sql =
            """
            UPDATE comments.outbox_messages
